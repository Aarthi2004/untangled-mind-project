...
if ($user_id !== null) {
    ...
    $stmt = $conn->prepare("SELECT user_id, Name, password, Age, Gender,p_Name,p_Age,p_Gender,Diagnosis,Relationship,phone_no,Caretaker_image FROM add_caretakers WHERE user_id = ?");
    ...
    if ($doctorData) {
        // Encode image data
        $imagePath = $doctorData['Caretaker_image'];
        $imageData = file_get_contents($imagePath);
        $base64Image = base64_encode($imageData);
        $doctorData['Caretaker_image'] = $base64Image;
