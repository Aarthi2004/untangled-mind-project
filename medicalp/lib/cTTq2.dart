...
import 'package:medicalp/cTTq3.dart';

class ttq2 extends StatefulWidget {
  final String username;
  final String name;

  ttq2({required this.username,required this.name});

  @override
  _ttq2State createState() => _ttq2State();
}

class _ttq2State extends State<ttq2> {
                ...
                GestureDetector(
                  onTap: () {
                    if (selectedOptionIndex != -1) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ttq3(username: widget.username, name: widget.name)),
                      );
                    } else {
