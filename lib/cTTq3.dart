...
import 'package:medicalp/cTTq4.dart';

class ttq3 extends StatefulWidget {
  final String username;
  final String name;
  ttq3({required this.username,required this.name});

  @override
  _ttq3State createState() => _ttq3State();
}

class _ttq3State extends State<ttq3> {
                ...
                GestureDetector(
                  onTap: () {
                    if (selectedOptionIndex != -1) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ttq4(username: widget.username, name: widget.name)),
                      );
                    } else {
